...
export default function Home() {
  ...
  return (
    <div className="flex-col flex bg-white dark:bg-black h-screen w-screen overflow-x-hidden scroll-smooth">
      ...
      <div className="h-[200vh] w-screen my-[148px] bg-[url('./hero_2x.webp')] bg-cover bg-center bg-no-repeat ">
...
<footer className="bg-white sm:mt-80 smMax:mt-[600px] 2xl:mt-1 dark:bg-black mt-0 ">
