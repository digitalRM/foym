    ...
    <div className="">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-base font-medium leading-7 bg-clip-text text-transparent bg-gradient-to-r from-brandBlue via-brandPink to-brandPink mx-52">Everything you need</h2>
...
<footer className="bg-white sm:mt-[16rem] smMax:mt-[600px] 2xl:mt-1 dark:bg-black mt-0 ">
    <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">foym.</a> & <a href="https://www.linkedin.com/in/ruslan-muk/" className="hover:underline">Ruslan Mukhamedvaleev.</a> All Rights Reserved.
          </span>
