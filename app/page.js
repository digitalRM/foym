        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="/" class="flex items-center">
                  <span class="self-center text-2xl font-semibold whitespace-nowrap font-sans dark:text-white">foym<span className="text-brandPink self-center text-2xl font-semibold whitespace-nowrap font-sans">.</span></span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 font-sans">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-black font-sans dark:text-white">Pages</h2>
                  <ul class="text-gray-600 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="/" class="hover:underline font-sans font-normal">Home Page</a>
                      </li>
                      <li>
                          <a href="/work" class="hover:underline font-sans font-normal">Previous Work</a>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-black dark:text-white">Legal</h2>
                  <ul class="text-gray-600 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline font-sans font-normal">Privacy Policy</a>
                      </li>
                      <li>
                          <a href="#" class="hover:underline font-sans font-normal">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      </div>
      <hr class="my-6 border-gray-200 sm:mx-auto dark:border-zinc-800 lg:my-8" />
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">foym</a>. All Rights Reserved.
          </span>
