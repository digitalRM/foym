  ...
  return (
      ...
      <div className="flex justify-center align-center flex-col mt-52 max-w-[290px] sm:max-w-none mx-auto text-center">
        ...
        <div className=" w-auto mt-24 mx-10">
          <Card className="dark:bg-black border-zinc-800 rounded-3xl p-3 w-full z-[6] relative my-4 mb-0 flex-1 sm:min-w-[477px]">
            <CardHeader className="dark:bg-black border-zinc-200 rounded-3xl flex flex-wrap flex-row">
              ...
              <Card className="dark:bg-black w-1/3 border-zinc-800 rounded-3xl p-3 z-[6] relative my-2 mb-0 flex-1 min-w-[360px] mr-6">
                <CardHeader className="dark:bg-black border-zinc-200 rounded-3xl">
                  ...
                  <div className="flex align-bottom h-[132px] place-items-center">
                    <CardDescription></CardDescription>
            ...
            <div className="mx-6">
              <Card className="dark:bg-black w-full border-zinc-800 rounded-3xl p-3 z-[6] relative my-4 mt-0 flex-1 min-w-[360px] ">
          ...
          <footer className="bg-white sm:mt-80 smMax:mt-[600px] 2xl:mt-1 dark:bg-black mt-0 relative z-50 ">
    <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 font-sans">
              <div>
