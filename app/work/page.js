  ...
  return (
    <div className="bg-black relative">
      ...
      <div className="flex justify-center align-center flex-col mt-52 max-w-[290px] sm:max-w-none mx-auto text-center">
        <h1 className="font-sans text-2xl text-black dark:text-white lg:text-6xl md:text-4xl sm:text-2xl font-semibold flex justify-center align-center tracking-tight">Our Work<span className="text-brandPink">.</span></h1>
          ...
          <div className="w-full m-2 p-[0px] sm:p-[2px] relative h-fit max-w-[1440px] xl:max-w-[1440px] " >
            ...
            <Card className="dark:bg-blackmax-w-[1440px] bg-black rounded-[50px] p-1 w-full z-[6] relative mb-0 flex-1 sm:min-w-[477px]">
              ...
              <CardHeader className="dark:bg-black rounded-[50px] flex flex-wrap flex-row sm:gap-6 gap-3 p-3 sm:p-12 lg:pr-0 sm:py-0 ">
                <Card className="dark:bg-black w-1/3 rounded-[32px] p-1 sm:p-3 z-[6] relative my-2 mb-0 flex-1 min-w-[100%] md:min-w-[50%] flex flex-wrap">
                  <CardHeader className="dark:bg-black rounded-3xl">
                    <CardTitle className="tracking-tight text-base md:text-2xl">Learn Link - An FOYM<span className="text-brandPink lg:text-4xl">.</span> Template</CardTitle>
                    <CardDescription className=" mt-3 " >This is the fifth fully open-source template we have created. This is a template for organizations modeled after a made-up tutoring nonprofit called “Learn Link.” It features an animated hero section via Framer Motion, two informational sections, and a frequently asked questions section.</CardDescription>

                  </CardHeader>
                  <div className="flex w-full max-w-[100%] items-center sm:space-x-2 z-20 p-2 m-4 mt-0 sm:mt-6 pt-0 pl-1 mb-2  relative smMax:flex-wrap">
                    <ButtonWithIconWork link="https://learn.foym.org" />
                    <ButtonWithIconWork link="https://github.com/digitalRM/FOYM-Learn-Link" color="code" />
                  </div>  
              ...
              <CardHeader className="dark:bg-black rounded-[50px] flex flex-wrap flex-row sm:gap-6 gap-3 p-3 sm:p-12 lg:pl-0 sm:py-0 ">
                <Card className="dark:bg-black w-1/3 rounded-[32px] p-1 sm:p-3 z-[6] relative my-2 mb-0 flex-1 min-w-[100%] md:min-w-[50%] flex flex-wrap">
                  <CardHeader className="dark:bg-black rounded-3xl">
                    <CardTitle className="tracking-tight text-base md:text-2xl">Grow Together - An FOYM<span className="text-brandPink lg:text-4xl">.</span> Template</CardTitle>
                    <CardDescription className=" mt-3 " >This is the sixth fully open-source template we have created. This is a template for organizations modeled after a made-up gardening nonprofit called “Grow Together.” It features a left-aligned hero, an information section, a testimonial section, and a frequently asked questions section.</CardDescription>

                  </CardHeader>
                  <div className="flex w-full max-w-[100%] items-center sm:space-x-2 z-20 p-2 m-4 mt-0 sm:mt-6 pt-0 pl-1 mb-2  relative smMax:flex-wrap">
                    <ButtonWithIconWork link="https://grow.foym.org" />
                    <ButtonWithIconWork link="https://github.com/digitalRM/FOYM-Grow-Together" color="code" />
                  </div>  
