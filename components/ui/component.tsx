...
const faqs = [
  ...
  },
  {
    id: 6,
    question:
      "Are there templates to choose from, or is the design built from scratch?",
    answer:
...
const faqs2 = [
  ...
  },
  {
    ...
    answer: "Typically, it costs around $10-15 USD per year.",
  },
];
    ...
    <div className="w-full h-full rounded-[30px] py-24 pt-12 sm:pt-12 sm:py-24 bg-black">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center sm:items-center pt-14 pb-4 flex flex-col">
          ...
          <p className="mt-2 text-2xl font-bold xs:tracking-tight tracking-[-0.035em] sm:max-w-none xss:max-w-[250px] text-white sm:text-4xl">
            Will that <span className="italic mr-0.5">really</span> help your
            misson?
          </p>
          <p className="mt-4 text-lg leading-8 text-neutral-400 max-w-[550px]">
            If so, great! If not, we can help. Break boundaries, change lives,
            or just do what you do best – don’t worry about the rest.
          </p>
        </div>
      </div>
          ...
          {features.map((feature) => (
            <div key={feature.name} className="flex flex-col">
              ...
              <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-neutral-400">
                ...
                <p className="mt-4">
                  {feature.name == "Impact Amplifying." ? (
                    <div></div>
                  ) : (
                    <Dialog>
                      <DialogTrigger className="text-sm font-semibold leading-6 text-white group transition">
                        ...
                        <ChevronRight
                          strokeWidth={2.5}
                          className="h-5 w-5 inline-flex group-hover:translate-x-1 transition"
                          aria-hidden="true"
                        />
                      </DialogTrigger>
                      ...
                      <DialogContent className="w-full max-w-[1240px] overflow-y-scroll scroll-smooth scroll-thin sm:rounded rounded-3xl md:rounded-tr-none h-auto  max-h-[95%] sm:max-h-[83%] bg-black sm:p-8 flex flex-col items-center ">
                        {feature.name == "Tailored & White Labeled." ? (
                          <div className="sm:p-12 p-3">
                            <h1 className="text-3xl font-bold tracking-tight py-6 pt-0 text-white sm:text-4xl">
                              Tailored & White Labeled
                              <span className="text-brandPink">.</span>
                            </h1>

                            <p className=" text-neutral-400">
                              It's simple – we work closely with you to
                              understand your organization and goals, then we
                              create a website that reflects your brand.
                              Afterwards, we assist in deploying your website
                              with white labeling, allowing you to take full
                              credit for the website without any pesky
                              watermarks.
                            </p>
                        ...
                        {feature.name == "At No Cost." ? (
                          <div className="sm:p-12 p-3">
                            <h1 className="text-3xl font-bold tracking-tight py-6 pt-0 text-white sm:text-4xl">
                              Free<span className="text-brandPink">.</span>
                            </h1>

                            <p className="text-neutral-400">
                              It's that simple. The coding, design, and
                              deployment of your website are completely free.
                              The only cost involved is for a custom domain
                              name, should you choose to purchase one. We do not
                              require any form of payment, nor do we accept
                              donations.
                            </p>
