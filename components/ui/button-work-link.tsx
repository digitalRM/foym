...
export function ButtonWithIconWork({link, color}) {
  ...
  return (
    ...
    <a target="_blank" href={link} className="group rounded-3xl smMax:mt-2  smMax:w-full w-full font-sans" rel="noopener noreferrer">
      <Button variant="outline" className="group rounded-3xl smMax:mt-2  smMax:w-full w-full font-sans" asChild>
        <div>
        View Code<ArrowUpRight className=' transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5 ml-0.5'  height='16' width='16'/>
        </div>
