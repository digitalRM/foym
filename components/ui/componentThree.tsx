...
const faqs = [
  ...
  },
  {
    id: 2,
    question:
      "What criteria must an organization meet to qualify for a free website?",
    answer:
  ...
  },
  {
    id: 7,
    question:
      "How does FOYM sustain itself financially while providing free websites?",
    answer:
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 sm:pt-12">
        <div className="w-full flex flex-col lg:justify-center lg:items-center pt-12 pb-5">
          ...
          <p className="mt-2 text-2xl font-bold tracking-tight text-white sm:text-4xl">
            Frequently Asked Questions<span className="text-brandPink">.</span>
          </p>
