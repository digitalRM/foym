        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 md:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              We welcome volunteers from all backgrounds across the globe to contribute their skills. Whether it's web development, content creation, design, or something entirely different, we'd love to have you on our team.
              </p>
              <p className="mt-6 text-lg leading-8 text-neutral-400">
              Your expertise can be a game-changer for organizations worldwide. Join us in our mission, and help us make a difference today.
              </p>
              ...
              <Button variant="outline" className=" border-zinc-800 text-white hover:text-white hover:bg-purple-700 bg-purple-600 sm:w-24" asChild>              
                  <Link href="https://docs.google.com/forms/d/e/1FAIpQLSfijcsbyMfWcblc6fBknXn5CuP967v603C93MaXbi0-2kpYOQ/viewform?usp=sf_link">Join Us</Link>
              </Button>
